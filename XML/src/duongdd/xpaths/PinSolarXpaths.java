    ...
    public PinSolarDTO xpathDetailPinSolar(String content) {
        ...
        try {
            ...
            if (doc != null) {
                ...
                String expCap_01 = "//div[@class='ProductDescriptionContainer']/h4[contains(text(),'W')]/text()";
                ...
                Node nodeCap_01 = (Node) xPath.evaluate(expCap_01, doc, XPathConstants.NODE);
                ...
                }else if(capacity.equals("") && nodeCap_01 != null){
                    capacity = nodeCap_01.getTextContent();
...
//                System.out.println(pinImage);
    ...
    public List xpathUrlPage(String content){
        ...
        try{
            ...
            if(doc != null){
                XPath xPath = XMLUtils.createXpath();
                String exp = "//div[@class='PageNavigation']/a";
